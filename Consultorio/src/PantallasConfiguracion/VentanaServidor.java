...
public class VentanaServidor {
    ...
    private JDialog getVentana() {
        if (ventana == null) {
            ...
            ventana.setTitle("Configuracion del Servidor");
    ...
    private JPanel getPanelUsuario() {
        if (panelUsuario == null) {
            ...
            panelUsuario.setBorder(BorderFactory.createTitledBorder(null, "Ingrese IP y Puerto del Servidor", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));

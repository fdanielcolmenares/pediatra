...
public class Utils {
     ...
     */
    public void encrypt(File in, File out, int pass) throws IOException {
     ...
     * @throws IOException            Si el archivo no se puede leer
     */
    public String readEncrypted(File in, int pass, int n) throws IOException {
    ...
    public String readEncrypted(File in, int pass) throws IOException {

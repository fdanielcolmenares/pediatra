...
public class TipoExamen {
	...
	private GestorTipoExamen gestor;  //  @jve:decl-index=0:
	public Modelo_Tabla modelo = null;

	public TipoExamen(int w, int h){
		getVentana();
	...
	public void setGestor(GestorTipoExamen g){
		gestor = g;
	}
	/**
	...
	public JInternalFrame getVentana() {
		if (Ventana == null) {
			...
			Ventana.setFrameIcon(new ImageIcon(getClass().getResource("/Files/Imagenes/Image068.png")));
			Ventana.setTitle("Tipos de Examenes");

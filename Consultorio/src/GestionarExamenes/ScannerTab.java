...
public class ScannerTab implements ScannerListener
{
	...
	public ScannerTab(String n, frmImagen v)
    {
        contima=n;
        ven=v;
    }
    ...
    public void update(uk.co.mmscomputing.device.scanner.ScannerIOMetadata.Type type, final ScannerIOMetadata scanneriometadata)
    {
        if(type.equals(ScannerIOMetadata.ACQUIRED))
        {
            (new Thread() {
                ...
                public void run()
                {
                    ...
                    try{
                      ImageIO.write(image,"jpg",new File("bin/ima/"+contima+".jpg"));
                      ven.mostrar("/ima/"+contima+".jpg");
                      //ven.desbloquear();
  					  ven.escanear();
                    }catch(Exception e){
                      e.printStackTrace();
